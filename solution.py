import pygame, sys, Enemy, shelve
...
class Game(object):
    ...
    def setup_enemies(self):
        self.enemy1 = Enemy.Enemy(160,140,1000,3000,False,self.enemy_image)
        self.enemy2 = Enemy.Enemy(351,140,2500,4500,False,self.enemy_image)
        self.enemy3 = Enemy.Enemy(355,401,4000,6500,False,self.enemy_image)
        self.enemy4 = Enemy.Enemy(200,401,6500,8000,False,self.enemy_image)
        self.enemy5 = Enemy.Enemy(258,275,8500,10500,False,self.enemy_image)
        self.enemy6 = Enemy.Enemy(460,527,10000,12000,False,self.enemy_image)
        self.enemy7 = Enemy.Enemy(45,528,12500,13500,False,self.enemy_image)
        self.enemy8 = Enemy.Enemy(255,530,13000,15000,False,self.enemy_image)
        self.enemy9 = Enemy.Enemy(450,94,14500,16500,False,self.enemy_image)
        self.enemy10 = Enemy.Enemy(62,94,16000,18000,False,self.enemy_image)
        self.enemy11 = Enemy.Enemy(242,94,18800,20000,False,self.enemy_image)
        self.enemies=[self.enemy1,self.enemy2,self.enemy3,self.enemy4,self.enemy5,self.enemy6,self.enemy7,self.enemy8,self.enemy9,self.enemy10,self.enemy11]
    ...
    def draw_mouse(self):
        ...
        self.screen.blit(self.cursor,(cordss[0],cordss[1]))
            ...
            if pygame.event.peek():
                ...
                if (event.type == MOUSEBUTTONDOWN):
                    ...
                    for enemy in self.enemies:
                        if(self.time_checker(self.time,enemy.born,enemy.died) and not enemy.hit):
                            enemy.hit=self.strike_checker(cords, enemy.x, enemy.y)
                            if(enemy.hit):
